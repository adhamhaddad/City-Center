...
const CARDS = path.join(__dirname, '..', 'uploads', 'card-images');
const DOCUMENTS = path.join(__dirname, '..', 'uploads', 'job-documents');
...
app.use('/uploads/card-images', express.static(CARDS));
app.use('/uploads/job-documents', express.static(DOCUMENTS));
